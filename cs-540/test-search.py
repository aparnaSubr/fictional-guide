...
def test_bfs(bfs_output, test_case_num):
    expected = [ ['BFS', 'Iteration:', '0', '(0,0)', '(2,0)(0,1)', 'Result:', '(0,0)(2,0)'], \
...
def test_dfs(dfs_output, test_case_num):
    expected = [ ['DFS', 'Iteration:', '0', '(0,0)', '(2,0)(0,1)', '1', '(0,0)(0,1)', '(2,1)(0,0)(1,0)', \
                  '2', '(0,0)(0,1)(1,0)', '(2,0)(1,1)(0,0)(0,1)', '3', '(0,0)(0,1)(1,0)(1,1)', \
                  '(2,1)(0,1)(1,0)(2,0)', 'Result:', '(0,0)(0,1)(1,0)(1,1)(2,0)'], \
...
def main():
    ...
    commands = ['2 1 2', '2 2 2', '2 1 1', '4 2 3', '6 2 5', '7 9 3']
    if compiled_success is True:
        for i in range(6):
